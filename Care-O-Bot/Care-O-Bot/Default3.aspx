...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="https://jquerycreditcardvalidator.com/jquery.creditCardValidator.js"></script>
...
<body>
  ...
  <div class="form-container">
    <form action="" runat="server">
      ...
      <input placeholder="Ad Soyad" type="text" name="name"><br>

      <div class="cardForm-Field50">
        <label for="expiry">Geçerlilik Tarihi</label><br>
        <input placeholder="MM/YY" type="text" name="expiry" class="secondRow">
      </div>
      <div class="cardForm-Field50">
        <label for="cvc">Güvenlik Kodu</label><br>
      ...
      <!-- Button Pay -->
        <div>
            <asp:Button Text="Öde                            " runat="server" class="button CardGood" OnClick="Unnamed1_Click" Style=" font-size:20px;font-weight:700; 'Roboto', sans-serif;cursor:pointer;" />
         <span style="position:absolute;top:435px;left:950px;font-size:25px; font-family: 'Roboto', sans-serif; color:white" ><asp:Label Text=" " ID="total" runat="server" Style=" left:0px;" /> TL </span>
        </div>
...
<script>
    $(".button.CardGood").click(function () {
